...
class BlockField(StrEnum):
    ...
    MESSAGE_OUTBOX_ROOT = 'message_outbox_root'
    HEIGHT = 'height'
    PREV_ROOT = 'prev_root'
    TIME = 'time'
...
class TransactionField(StrEnum):
    ...
    SALT = 'salt'
    POLICIES_TIP = 'policies_tip'
    POLICIES_WITNESS_LIMIT = 'policies_witness_limit'
    POLICIES_MATURITY = 'policies_maturity'
    POLICIES_MAX_FEE = 'policies_max_fee'
    SCRIPT_GAS_LIMIT = 'script_gas_limit'
    MINT_GAS_PRICE = 'mint_gas_price'
    BYTECODE_ROOT = 'bytecode_root'
    SUBSECTION_INDEX = 'subsection_index'
    SUBSECTIONS_NUMBER = 'subsections_number'
    PROOF_SET = 'proof_set'
    CONSENSUS_PARAMETERS_UPGRADE_PURPOSE_WITNESS_INDEX = 'consensus_parameters_upgrade_purpose_witness_index'
    CONSENSUS_PARAMETERS_UPGRADE_PURPOSE_CHECKSUM = 'consensus_parameters_upgrade_purpose_checksum'
    STATE_TRANSITION_UPGRADE_PURPOSE_ROOT = 'state_transition_upgrade_purpose_root'
